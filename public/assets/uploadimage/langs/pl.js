tinymce.addI18n('pl',{
	'Insert an image from your computer': 'Wstaw obrazek z komputera',
  'Insert image': 'Wstaw obrazek',
  'Choose an image': "Wybierz obrazek",
  'You must choose a file': "Musisz wybrać plik",
  'Got a bad response from the server': "Błąd serwera",
  "Didn't get a response from the server": "Serwer nie odpowiada",
  'Insert': "Wstaw",
  'Cancel': "Anuluj",
