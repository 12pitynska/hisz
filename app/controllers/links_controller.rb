...
#before_action :authenticate_user!, :except => [:index]
  ...
  def create
    ...
    respond_to do |format|
      if @link.save
        format.html { redirect_to links_path, notice: 'Link został pomyślnie dodany. Będzie on widoczny w serwisie po zaakceptowaniu przez moderatora.' }
  ...
  def update
    respond_to do |format|
      if @link.update(link_params)
        format.html { redirect_to links_path, notice: 'Link został pomyślnie zaktualizowany.' }
